...
import JobDetailAddToCart from "../../../../../features/jobs/JobDetailAddToCart";

// DYNAMIC ROUTE — /dashboard/jobs/[id]. Server-fetches the job, then hands
// off to a small Client Component for the one interactive piece (Add to Cart).
